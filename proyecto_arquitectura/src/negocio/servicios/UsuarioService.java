...
public class UsuarioService {
    ...
    public void registrarUsuario(int id, String nombre, String correo, String telefono, String rol, String rolQuienRegistra) {
        ...
        if (rolQuienRegistra.equals("SOLICITANTE") && rol.equals("FUNCIONARIO")) {
            System.out.println("Error: Un solicitante no puede registrar usuarios con rol FUNCIONARIO.");
            return;
        }
